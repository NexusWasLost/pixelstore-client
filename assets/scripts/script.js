...
function renderItems(itemsList) {
    ...
    while (i < itemsList.length) {
        ...
        const formattedPrice = formatPrice(item.MRP);
        ...
        card.innerHTML = `<div>
                    ...
                    <span class="tax-tag"><i class="ri-percent-line"></i>${item.taxApplicable}% GST</span>
                    </div>
                    ...
                    <button class="btn-buy">Buy Now<i class="ri-arrow-right-line"></i></button>
                    </div>`;
...
function handleBuy(itemId) {
    ...
    // Trigger checkout modal or route here
}
